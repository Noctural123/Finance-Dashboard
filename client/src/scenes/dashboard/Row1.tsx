...
import { ResponsiveContainer, AreaChart, Area, XAxis, YAxis, CartesianGrid, Tooltip, Line, Legend, LineChart, BarChart, Bar, Rectangle } from 'recharts'
    ...
    <>
      <DashboardBox gridArea="a">
        <BoxHeader
          ...
          subtitle="Revenue (Top) vs Expenses (Bottom)"
          sideText="+4%"
        />
